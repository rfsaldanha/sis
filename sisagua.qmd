...
<audio class="podcast-audio" controls preload="metadata">
  <source src="https://sis-podcasts.nyc3.cdn.digitaloceanspaces.com/sisagua_dialogo_eleven_v3.mp3?v=20260713-elevenv3" type="audio/mpeg">
...
%%| fig-alt: "Fluxograma do SISAGUA: cadastro das formas de abastecimento, controle pelo responsável, vigilância do setor saúde e resultados laboratoriais alimentam o sistema; relatórios, painéis e dados abertos apoiam a gestão de risco e as ações de saúde."
flowchart LR
