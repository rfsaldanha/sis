...
: Escalas territoriais usadas na regionalização do SUS {#tbl-escalas-regionalizacao}
...
: Exemplos de uso das Regiões de Saúde na análise dos SIS {#tbl-aplicacoes-regionalizacao}
...
- [Estimativas populacionais — seção “Fontes de estimativas”](pop.html#fontes-de-estimativas). Na edição impressa, p. 393.
