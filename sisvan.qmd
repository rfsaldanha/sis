...
- [Siaps — Sistema de Informação para a Atenção Primária à Saúde — seção “Exemplo: produção da APS”](sisaps.html#exemplo-produção-da-aps). Na edição impressa, p. 304.
