...
Adaptado do documento de [estrutura do SIM](www/assets/sim/Estrutura_SIM_para_CD.pdf).

| Sessão | Nome do campo | Nome DBF | Valores válidos | Descrição | Característica | Disponibilidade |
