...
A causa básica do óbito é o agravo que **inicia** a cadeia de eventos mórbidos que leva diretamente à morte -- ou, no caso de causas externas, as circunstâncias do acidente/violência que produziram a lesão fatal. Essa definição é a referência internacional utilizada para padronizar estatísticas de mortalidade por causa, permitindo comparabilidade e interpretação epidemiológica (@who_cause_of_death_page).

Na Declaração de Óbito (DO), o médico responsável deve descrever, na Parte I do documento, a sequência causal (da causa terminal às antecedentes), anotando a causa básica na última linha preenchida. Já a Parte II da DO é destinada a outras condições relevantes que contribuíram para o óbito, mas que não entram na cadeia causal principal. O manual do Ministério da Saúde reforça que a qualidade dessa informação depende de relatar toda a cadeia (e não apenas a causa terminal) (@brasil_ms_2022_do_manual).
