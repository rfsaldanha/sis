...
![Modelo de Declaração de Óbito](assets/sim/Wikipedia-Declarac%CC%A7a%CC%83o_de_o%CC%81bito_Brasil.jpg){#modelo-do}

## Estrutura e dicionário de dados

Confira o documento de [estrutura do SIM](assets/sim/Estrutura_SIM_para_CD.pdf).
