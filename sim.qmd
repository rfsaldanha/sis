...
Mais informações sobre o preenchimento dos dados do SIM estão disponíveis no [manual de preenchimento](www/assets/sim/declaracao-obito-manual-instrucoes-preenchimento.pdf), disponibilizado pelo Ministério da Saúde.

## Modelo da Declaração de Óbito

![Modelo de Declaração de Óbito](images/Wikipedia-Declarac%CC%A7a%CC%83o_de_o%CC%81bito_Brasil.jpg){#modelo-do}

## Estrutura e dicionário de dados

Confira o documento de [estrutura do SIM](www/assets/sim/Estrutura_SIM_para_CD.pdf).
...
Segundo a RIPSA [@OPAS2008], os dados do SIM são utilizados na construção de diversos indicadores de mortalidade. Pode-se destacar os seguintes:
...
-  [Histórico do SIM](www/assets/sim/INTRO.pdf)
-  [Estrutura do SIM](www/assets/sim/Estrutura_SIM_para_CD.pdf)
-  [Manual de preenchimento da Declaração de Óbito](www/assets/sim/declaracao-obito-manual-instrucoes-preenchimento.pdf)
-  [A Declaração de Óbito: documento necessário e importante](www/assets/sim/a-declaracao-de-obito-documento-necessario-e-importante.pdf)
...
### Qualidade do preenchimento dos dados
