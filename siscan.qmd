...
# SISCAN -- Sistema de Informação de Câncer {#sec-siscan}
...
O SISCAN utiliza o Cadastro de Usuários do SUS (CADSUS) para identificação nominal e o CNES para caracterizar unidades solicitantes e prestadores. Essa integração reduz redigitação, apoia o acompanhamento da pessoa e permite relacionar produção, território e capacidade instalada.
...
O acesso público ao Painel Oncologia está disponível em https://tabnet.datasus.gov.br/cgi/dhdat.exe?PAINEL_ONCO/PAINEL_ONCOLOGIABR.def=. A consulta deve registrar a data de extração, os filtros, a abrangência geográfica e o período selecionado.
...
Para estudar tempo, identifique claramente os marcos usados: solicitação, realização, liberação do resultado, diagnóstico ou primeiro tratamento. O SISCAN detalha parte inicial desse percurso; o Painel Oncologia relaciona diagnóstico e tratamento em diferentes sistemas. Os dois intervalos não são intercambiáveis.
...
Em séries temporais, competência de processamento, data da solicitação, data do exame e data do laudo podem produzir curvas diferentes. Períodos recentes são particularmente sensíveis a atraso de digitação. Mudanças de versão, regras, implantação e cobertura precisam ser assinaladas junto aos resultados.

## Acesso aos dados

### SISCAN no TabNet

As tabulações públicas do SISCAN estão disponíveis na página do DATASUS em https://datasus.saude.gov.br/acesso-a-informacao/sistema-de-informacao-do-cancer-siscan-colo-do-utero-e-mama/. As opções e os períodos disponíveis devem ser conferidos na data da consulta [@datasusSiscan2026].

### SISCOLO e SISMAMA

As séries históricas dos sistemas antecessores podem ser consultadas em https://datasus.saude.gov.br/acesso-a-informacao/cancer-de-colo-de-utero-e-de-mama-siscolo-sismama/. Elas são importantes para análises anteriores e para avaliar a transição entre sistemas [@datasusSiscoloSismama2026].

### Acesso ao Painel Oncologia

O Painel Oncologia pode ser tabulado em https://tabnet.datasus.gov.br/cgi/dhdat.exe?PAINEL_ONCO/PAINEL_ONCOLOGIABR.def=. A página institucional de controle do câncer, em https://www.gov.br/saude/pt-br/composicao/saes/cgcan, descreve a ferramenta e suas fontes [@brasilPainelOncologia2026].

### Manuais e relatórios

O manual do SISCAN está organizado em módulos sobre apresentação e fluxo, exames e faturamento, seguimento e monitoramento da qualidade. Ele pode ser consultado em https://www.inca.gov.br/publicacoes/manuais/manual-do-sistema-de-informacao-do-cancer-siscan-modulos-1-2-3-e-4 [@incaManualSiscan2021]. O relatório de qualidade dos dados está disponível em https://www.inca.gov.br/publicacoes/relatorios/qualidade-dos-dados-do-sistema-de-informacao-do-cancer-siscan-2016-2020 [@incaQualidadeSiscan2022].
...
- As limitações foram apresentadas junto às conclusões.
...
- [Manual do Sistema de Informação de Câncer](https://www.inca.gov.br/publicacoes/manuais/manual-do-sistema-de-informacao-do-cancer-siscan-modulos-1-2-3-e-4) [@incaManualSiscan2021].
...
- Artigo *PAINEL-Oncologia: uma ferramenta de gestão* [@attyPainelOncologia2020]. Disponível em https://doi.org/10.32635/2176-9745.RBC.2020v66n2.827.
- Artigo *Cobertura dos Sistemas de Informação dos Cânceres do Colo do Útero e de Mama no Brasil, 2008-2019* [@tomazelliCoberturaSistemasCancer2022]. Disponível em https://doi.org/10.32635/2176-9745.RBC.2022v68n1.1544.
...
- [SIA — Sistema de Informações Ambulatoriais do SUS — seção “Exemplo: produção de mamografias”](sia.html#exemplo-produção-de-mamografias). Na edição impressa, p. 126.
...
- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Relacionamento determinístico”](interoperabilidade.html#relacionamento-determinístico). Na edição impressa, p. 436.
