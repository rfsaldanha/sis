...
<audio class="podcast-audio" controls preload="metadata">
  <source src="https://sis-podcasts.nyc3.cdn.digitaloceanspaces.com/siscan_dialogo_eleven_v3.mp3?v=20260716-elevenv3" type="audio/mpeg">
...
- [SIA — Sistema de Informações Ambulatoriais do SUS — seção “Exemplo: produção de mamografias”](sia.html#exemplo-produção-de-mamografias). Na edição impressa, p. 144.
...
- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Relacionamento determinístico”](interoperabilidade.html#relacionamento-determinístico). Na edição impressa, p. 450.
