...
- [SINAN — Sistema de Informação de Agravos de Notificação — seção “SINAN e SIVEP”](sinan.html#sinan-e-sivep). Na edição impressa, p. 192.

- [Eventos de saúde — seção “Casos de doenças e agravos”](eventos.html#casos-de-doenças-e-agravos). Na edição impressa, p. 48.

- [SISAGUA — Sistema de Informação de Vigilância da Qualidade da Água para Consumo Humano — seção “Monitoramento em emergências”](sisagua.html#monitoramento-em-emergências). Na edição impressa, p. 242.
