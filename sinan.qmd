...
Esses erros têm em comum a perda do processo de vigilância que produziu o registro. A análise fica mais robusta quando o texto diferencia suspeição, investigação, confirmação, encerramento e atualização da base. Em produtos públicos, essa distinção deve aparecer nas legendas, notas metodológicas e interpretação dos resultados, especialmente quando há comparação temporal ou territorial.
...
- [Eventos de saúde — seção “Casos de doenças e agravos”](eventos.html#casos-de-doenças-e-agravos). Na edição impressa, p. 50.

- [SIVEP — Sistema de Vigilância Epidemiológica — seção “SIVEP-Gripe”](sivep.html#sivep-gripe). Na edição impressa, p. 375.

- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Etapas de um *linkage*”](interoperabilidade.html#etapas-de-um-linkage). Na edição impressa, p. 402.
