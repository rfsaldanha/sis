...
A regulação depende de diferentes sistemas, pois beneficiário, plano, operadora, atendimento e situação financeira são unidades distintas. A existência de um padrão comum não transforma esses registros em uma única base nem elimina diferenças de finalidade.
...
- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Dados públicos e bases institucionais”](interoperabilidade.html#dados-públicos-e-bases-institucionais). Na edição impressa, p. 428.
