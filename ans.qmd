...
A Constituição Federal de 1988 consolidou a saúde como direito de todos e dever do Estado, instituiu as bases do SUS e permitiu a atuação da iniciativa privada na assistência à saúde. Durante a década seguinte, o mercado de planos operou sem uma agência setorial e com regras fragmentadas, embora seguradoras já estivessem submetidas ao controle econômico-financeiro da Superintendência de Seguros Privados [@brasilConstituicao1988].
...
- [Organização dos SIS — seção “Cobertura: todo o território, SUS e saúde suplementar”](organizacao.html#cobertura-todo-o-território-sus-e-saúde-suplementar). Na edição impressa, p. 41.

- [CNES — Cadastro Nacional de Estabelecimentos de Saúde — seção “Rede SUS, privada, filantrópica e suplementar”](cnes.html#rede-sus-privada-filantrópica-e-suplementar). Na edição impressa, p. 206.

- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Dados públicos e bases institucionais”](interoperabilidade.html#dados-públicos-e-bases-institucionais). Na edição impressa, p. 444.

- [Inquéritos e pesquisas de saúde — seção “Vigitel”](inqueritos.html#vigitel). Na edição impressa, p. 403.
