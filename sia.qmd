...
O @qua-sia-checagens-automaticas-uteis-antes-da-analise sintetiza os elementos discutidos. Também é útil comparar totais agregados com o TabNet no mesmo período, UF, instrumento e procedimento. Diferenças pequenas podem resultar de filtros, competência ou processamento; diferenças grandes geralmente indicam seleção incorreta de arquivos ou variáveis.
...
O @qua-sia-checklist-de-qualidade-para-analises-com-sia sintetiza os elementos discutidos. O checklist deve ser usado como uma revisão final da coerência entre pergunta, fonte e indicador. Ele não substitui a leitura do dicionário nem a validação contra totais agregados, mas ajuda a identificar rapidamente se a análise trocou unidade, território ou sentido do valor registrado.
...
- [SIH — Sistema de Informações Hospitalares do SUS — seção “SIH e SIA”](sih.html#sih-e-sia). Na edição impressa, p. 101.

- [CNES — Cadastro Nacional de Estabelecimentos de Saúde — seção “Relacionamento com outros sistemas”](cnes.html#relacionamento-com-outros-sistemas). Na edição impressa, p. 220.
