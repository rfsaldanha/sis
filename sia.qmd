...
<audio class="podcast-audio" controls preload="metadata">
  <source src="podcast/sia.mp3?v=20260712-elevenv3" type="audio/mpeg">
...
- [Eventos de saúde — seção “Procedimentos ambulatoriais”](eventos.html#procedimentos-ambulatoriais). Na edição impressa, p. 60.

- [SIH — Sistema de Informações Hospitalares do SUS — seção “SIH e SIA”](sih.html#sih-e-sia). Na edição impressa, p. 117.

- [CNES — Cadastro Nacional de Estabelecimentos de Saúde — seção “Relacionamento com outros sistemas”](cnes.html#relacionamento-com-outros-sistemas). Na edição impressa, p. 209.

- [SISCAN — Sistema de Informação do Câncer — seção “Integração com SIA/SUS, CNES e CadSUS”](siscan.html#integração-com-siasus-cnes-e-cadsus). Na edição impressa, p. 226.
