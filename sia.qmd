...
Os nomes e a disponibilidade das variáveis variam conforme PA, APAC, BPA-I e RAAS. Em uma primeira inspeção, costuma ser útil verificar: (ver @qua-sia-campos-uteis-para-uma-primeira-inspecao-dos-dados-do-sia).
...
- [CNES — Cadastro Nacional de Estabelecimentos de Saúde — seção “Relacionamento com outros sistemas”](cnes.html#relacionamento-com-outros-sistemas). Na edição impressa, p. 221.
