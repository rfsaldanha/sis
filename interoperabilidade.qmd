...
- [RNDS — Rede Nacional de Dados em Saúde — seção “FHIR, terminologias e semântica”](rnds.html#fhir-terminologias-e-semântica). Na edição impressa, p. 347.

- [Eventos de saúde — seção “Relacionamento entre sistemas”](eventos.html#relacionamento-entre-sistemas). Na edição impressa, p. 62.

- [ANS — Agência Nacional de Saúde Suplementar — seção “Integração com dados dos SIS”](ans.html#integração-com-dados-dos-sis). Na edição impressa, p. 442.

- [SISCAN — Sistema de Informação do Câncer — seção “Painel Oncologia”](siscan.html#painel-oncologia). Na edição impressa, p. 225.
