...
- [Eventos de saúde — seção “Relacionamento entre sistemas”](eventos.html#relacionamento-entre-sistemas). Na edição impressa, p. 62.

- [Agência Nacional de Saúde Suplementar — ANS — seção “Integração com dados dos SIS”](ans.html#integração-com-dados-dos-sis). Na edição impressa, p. 432.

- [SISCAN — Sistema de Informação do Câncer — seção “Painel Oncologia”](siscan.html#painel-oncologia). Na edição impressa, p. 221.
