...
<audio class="podcast-audio" controls preload="metadata">
  <source src="https://sis-podcasts.nyc3.cdn.digitaloceanspaces.com/cnes_dialogo_eleven_v3.mp3?v=20260712-elevenv3" type="audio/mpeg">
...
::: {.callout-note}
Estabelecimento de saúde é definido como o espaço físico delimitado e permanente no qual se realizam ações e serviços de saúde humana sob responsabilidade técnica (art. 360 da PRC/MS nº 1/2017) [@brasilPortariaConsolidacao12017].
:::
...
%%| fig-alt: "Fluxograma do CNES: o estabelecimento preenche ou atualiza a FCES; o gestor municipal ou estadual aplica críticas e validações; a base por competência alimenta TabNet, arquivos DBC, OpenDataSUS, SIA, SIH e outros sistemas."
flowchart TD
...
Os dados do CNES são distribuídos em famílias de arquivos por competência, UF e módulo cadastral. O documento de [estrutura do CNES](assets/cnes/IT_CNES_1706.pdf) descreve variáveis e leiautes disponíveis (ver @qua-cnes-prefixos-comuns-dos-arquivos-do-cnes).
...
Em análises temporais, use a competência como eixo principal. Estabelecimentos podem abrir, fechar, mudar de município, tipo, gestão, natureza jurídica, serviços, habilitações e leitos. Para comparar séries, documente mudanças de leiaute e classificações. @coelhoAnaliseClarezaMetodologica2024 destacam, por exemplo, mudanças documentais e de clareza metodológica relevantes para interpretar formas de contratação e classificações do CNES.
...
- [SIH — Sistema de Informações Hospitalares do SUS — seção “Exemplo: fluxos de internação”](sih.html#exemplo-fluxos-de-internação). Na edição impressa, p. 123.

- [Siaps — Sistema de Informação para a Atenção Primária à Saúde — seção “Exemplo: Siaps + CNES”](sisaps.html#sec-related-sisaps-exemplo-sisaps-cnes). Na edição impressa, p. 303.
