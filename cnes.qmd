...
- [Siaps — Sistema de Informação para a Atenção Primária à Saúde — seção “Exemplo: Siaps + CNES”](sisaps.html#sec-related-sisaps-exemplo-sisaps-cnes). Na edição impressa, p. 294.
