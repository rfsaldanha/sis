...
- [SIH — Sistema de Informações Hospitalares do SUS — seção “Exemplo: fluxos de internação”](sih.html#exemplo-fluxos-de-internação). Na edição impressa, p. 125.

- [Siaps — Sistema de Informação para a Atenção Primária à Saúde — seção “Exemplo: Siaps + CNES”](sisaps.html#sec-related-sisaps-exemplo-sisaps-cnes). Na edição impressa, p. 305.
