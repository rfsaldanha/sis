...
**Duração:** 23 minutos e 39 segundos

## Arco narrativo

O episódio parte da pergunta sobre se mil mamografias representam mil mulheres rastreadas. A conversa reconstrói a passagem de SISCOLO e SISMAMA ao SISCAN, acompanha o fluxo entre solicitação, exame, laudo e seguimento e chega ao Painel Oncologia para discutir integração, relacionamento determinístico e oportunidade do tratamento. Ao final, a pergunta inicial é retomada para distinguir exame, pessoa, indicação e território.
