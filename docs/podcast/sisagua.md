...
**Duração:** 25 minutos e 5 segundos

## Arco narrativo

O episódio acompanha uma dúvida de vigilância em um município rural: não houve resultado fora do padrão, então a água está segura? O percurso diferencia cadastro, controle e vigilância; passa pelas formas de abastecimento, amostragem e parâmetros; e retorna à pergunta inicial para mostrar por que ausência de inconformidade pode significar ausência de monitoramento.
