...
**APRESENTADORA:** A primeira parte registra a cadeia causal: causa direta, causas intermediárias e causa básica na última linha preenchida. A segunda parte registra outras condições significativas que contribuíram para o óbito, mas que não fazem parte da cadeia principal.
...
**APRESENTADORA:** Aí o checklist mostra a integração do SIM com o SINASC. O numerador é óbitos de menores de um ano no SIM. O denominador é nascidos vivos do SINASC no mesmo território e período. E a distinção entre óbito fetal e nascimento vivo seguido de óbito é decisiva.
...
**ESTUDANTE:** A tabela parece objetiva, e o gráfico parece limpo. Isso pode dar uma falsa sensação de certeza?

**APRESENTADORA:** Pode. A incerteza não desaparece só porque ganhou uma boa apresentação. Por isso, a qualidade entra na análise antes da conclusão.
...
**APRESENTADORA:** Exato. SIM com SINASC para mortalidade infantil. SIM com SINAN para óbitos entre casos notificados. SIM com SIH para óbitos após internação. SIM com população para taxas. Mas cada base tem unidade de análise diferente: óbito, nascimento, notificação, internação, pessoa, evento. O método precisa declarar janela temporal, campos de pareamento, duplicidades e discordâncias.
...
**ESTUDANTE:** A Declaração chegou ao fim do percurso, e agora sabemos enxergar tudo o que existe por trás de uma linha da base.

**APRESENTADORA:** Essa é a leitura que vamos levar aos próximos capítulos. Obrigada pela companhia, e até o próximo episódio!
