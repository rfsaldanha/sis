...
- [Eventos de saúde — seção “Nascimentos”](eventos.html#nascimentos). Na edição impressa, p. 62.

- [SIM — Sistema de Informações sobre Mortalidade — seção “Exemplo: mortalidade infantil”](sim.html#exemplo-mortalidade-infantil). Na edição impressa, p. 84.

- [CID — Classificação Internacional de Doenças — seção “CID nos sistemas brasileiros”](cid.html#cid-nos-sistemas-brasileiros). Na edição impressa, p. 389.
