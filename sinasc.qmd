...
```{=html}
<section class="podcast-player" data-transcript="podcast/sinasc_transcript.json?v=20260710-elevenv3">
...
<audio class="podcast-audio" controls preload="metadata">
  <source src="podcast/sinasc.mp3?v=20260710-elevenv3" type="audio/mpeg">
