# SISAPS -- Sistema de Informação para a Atenção Primária à Saúde {#sec-siaps}
...
O nome histórico é SISAB. A plataforma renovada aparece nos materiais oficiais como Siaps, “Sistema de Informação para a Atenção Primária à Saúde”. Neste livro, adota-se SISAPS no título e na exposição geral, enquanto as referências a materiais oficiais preservam a forma Siaps.
:::

## Quando usar o SISAPS

Use o SISAPS/SISAB quando a pergunta envolve organização, produção, acompanhamento e desempenho da APS (ver @qua-sisaps-perguntas-comuns-que-podem-ser-respondidas-com-sisaps-sisab).
...
Perguntas comuns que podem ser respondidas com SISAPS/SISAB
...
Unidades de análise frequentes no SISAPS/SISAB
...
O uso do SISAPS/Siaps para cofinanciamento exige cuidado com regras de cálculo, competência, prazo de envio e composição dos denominadores. Mudanças normativas podem alterar indicadores e dificultar comparações entre períodos (ver @qua-sisaps-elementos-de-indicadores-de-cofinanciamento-da-aps).
...
|---|---|---|
| CNES da equipe existe? | SISAPS + CNES (@sec-cnes) | Relacionar pela mesma competência ou competência de referência |
...
Validações entre SISAPS/SISAB e CNES
...
Dimensões de qualidade relevantes no SISAPS/SISAB
...
Séries temporais do SISAPS/SISAB exigem atenção à transição SIAB-SISAB-SISAPS, mudanças de indicadores, mudanças de financiamento, prazos de envio e reorganização de equipes (ver @qua-sisaps-cuidados-em-analises-temporais-e-territoriais-da-aps).
...
- [SISAPS/Siaps](https://sisaps.saude.gov.br/sistemas/siaps/)
...
- [Manual do SISAPS/Siaps](https://sisaps.saude.gov.br/sistemas/siaps/docs/manual/apresentacao/)
- [Calendário Siaps](https://sisaps.saude.gov.br/sistemas/siaps/docs/manual/calendario-siaps/)

## Relacionamento com outros sistemas

O SISAPS/SISAB pode ser combinado com sistemas de oferta, produção, eventos e população. O ponto crítico é distinguir território de residência, território de acompanhamento, estabelecimento, equipe e local do evento (ver @qua-sisaps-integracoes-frequentes-entre-sisaps-sisab-e-outros-sistemas).

::: {#qua-sisaps-integracoes-frequentes-entre-sisaps-sisab-e-outros-sistemas}

| Pergunta | Fontes combinadas | Cuidado principal |
|---|---|---|
| Oferta da APS acompanha produção? | SISAPS/SISAB + CNES (@sec-cnes) | Equipes e estabelecimentos devem ser compatíveis por competência |
| APS reduz internações evitáveis? | SISAPS/SISAB + SIH (@sec-sih) | Evitar inferência causal simples com dados agregados |
| Pré-natal se relaciona a desfechos de nascimento? | SISAPS/SISAB + SINASC (@sec-sinasc) | Relacionamento direto exige regras de privacidade e *linkage* |
| Acompanhamento de agravos aparece na vigilância? | SISAPS/SISAB + SINAN (@sec-sinan) | Notificação e cuidado são processos diferentes |
| Produção ambulatorial é coerente? | SISAPS/SISAB + SIA (@sec-sia) | Produção da APS e faturamento/procedimentos têm escopos distintos |
| Cobertura por população | SISAPS/SISAB + POP (@sec-pop) | População cadastrada e população residente são denominadores diferentes |

Integrações frequentes entre SISAPS/SISAB e outros sistemas

:::

### *Checklist* para integração

Antes de combinar SISAPS/SISAB com outra base, defina claramente a unidade territorial, a competência e o denominador (ver @qua-sisaps-verificacoes-antes-de-integrar-dados-da-aps-com-outros-sistemas).
...
Limitações recorrentes do SISAPS/SISAB

:::

## Cuidados de interpretação

Ao utilizar o SISAPS/SISAB, alguns cuidados são recorrentes:
...
Itens mínimos para reprodutibilidade em análises do SISAPS/SISAB
