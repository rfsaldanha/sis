...
O acompanhamento pré-natal é um exemplo útil porque envolve cadastro, atendimento, registro oportuno e possível relacionamento com SINASC (@sec-sinasc). A pergunta deve definir se o foco é produção registrada, cobertura do acompanhamento ou desfecho materno-infantil.
...
- [SINASC — Sistema de Informação sobre Nascidos Vivos — seção “Uso como denominador”](sinasc.html#uso-como-denominador). Na edição impressa, p. 96.
