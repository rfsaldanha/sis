...
Neste livro, os SIS são apresentados a partir de quatro critérios principais: (ver @qua-organizacao-criterios-uteis-para-compreender-a-organizacao-dos-sis-brasileiros).
...
- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Aplicação aos SIS”](interoperabilidade.html#aplicação-aos-sis). Na edição impressa, p. 424.
