...
O quadro a seguir resume escolhas frequentes de acordo com o tipo de pergunta. Ela não substitui a leitura dos capítulos específicos, mas ajuda a direcionar a busca inicial.
...
- [Interoperabilidade entre os Sistemas de Informação em Saúde — seção “Aplicação aos SIS”](interoperabilidade.html#aplicação-aos-sis). Na edição impressa, p. 418.
