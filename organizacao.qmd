...
O Sistema de Informação em Saúde para a Atenção Básica (SISAB) (@sec-sisab) organiza informações da Atenção Básica, incluindo equipes, produção e indicadores relacionados à estratégia e-SUS Atenção Básica.
...
| SISAB (@sec-sisab) | Produção e indicadores da Atenção Básica | Gestão, monitoramento e avaliação da Atenção Básica |
...
Outros sistemas registram principalmente eventos ou produção vinculados à dimensão pública do SUS, incluindo rede própria e rede conveniada. SIH (@sec-sih), SIA (@sec-sia), SIOPS (@sec-siops), SISAB (@sec-sisab) e SI-PNI (@sec-sipni) devem ser interpretados com essa delimitação em mente.
