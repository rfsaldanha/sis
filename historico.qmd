...
- [Introdução — seção “Sistemas, contextos e usos”](introducao.html#sistemas-contextos-e-usos). Na edição impressa, p. 20.

- [Organização dos SIS — seção “Sistemas como fluxos de registro”](organizacao.html#sistemas-como-fluxos-de-registro). Na edição impressa, p. 38.
