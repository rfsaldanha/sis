...
A consolidação dos SIS brasileiros ocorreu de forma progressiva, acompanhando mudanças nas necessidades de vigilância, assistência, financiamento e gestão. Alguns marcos ajudam a compreender a posição de cada sistema no conjunto apresentado neste livro: (ver @qua-historico-marcos-de-criacao-e-consolidacao-dos-principais-sistemas-abordados-no).
