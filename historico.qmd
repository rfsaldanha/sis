...
| PNI e SI-PNI (@sec-sipni) | Programa Nacional de Imunizações criado em 1975; novo SI-PNI implantado a partir dos anos 2000 | Registro e monitoramento das ações de imunização |
...
- [Introdução — seção “Sistemas, contextos e usos”](introducao.html#sistemas-contextos-e-usos). Na edição impressa, p. 11.

- [Organização dos SIS — seção “Sistemas como fluxos de registro”](organizacao.html#sistemas-como-fluxos-de-registro). Na edição impressa, p. 28.
