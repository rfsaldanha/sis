...
Entre as décadas de 1970 e 1980 foram criados os primeiros sistemas de informação em saúde de abrangência nacional [@ministeriodasaudeExperienciaBrasileiraEm2009]. Nesse período, destacam-se a criação do Sistema de Informação sobre Mortalidade (SIM), a estruturação de registros relacionados ao Programa Nacional de Imunizações (PNI) e a organização de bases voltadas à produção assistencial.
