...
<audio class="podcast-audio" controls preload="metadata">
  <source src="https://sis-podcasts.nyc3.cdn.digitaloceanspaces.com/introducao_dialogo_eleven_v3.mp3" type="audio/mpeg">
...
::::: {.callout}
Sistemas de Informação em Saúde (SIS) podem ser entendidos como um esforço integrado para *coletar, processar, comunicar e utilizar* informações e conhecimentos em saúde para subsidiar decisões, ações programáticas e pesquisas [@lippeveldRoutineHealthInformation2001].
:::
...
![Sistemas de informação e o ciclo de vida do cidadão](assets/ciclo_vida_sistemas.png){#fig-ciclo-vida-sistemas fig-alt="Diagrama circular do ciclo de vida do cidadão cercado por sistemas de informação em saúde, entre eles SIM, SINASC, SI-PNI, SIA/SUS, e-SUS AB, SISVAN, SIOPS, CNES, SISCAN, SINAN e SIH/SUS."}
...
Este livro apresenta os principais SIS brasileiros, com informações atualizadas sobre sua história, as características de seus dados e suas formas de uso. O objetivo é favorecer o aproveitamento crítico de seu potencial para a saúde pública brasileira.
...
- [Breve histórico da experiência brasileira — seção “Sistemas nacionais e construção do SUS”](historico.html#sistemas-nacionais-e-construção-do-sus). Na edição impressa, p. 23.

- [Organização dos SIS — seção “Critérios de organização”](organizacao.html#critérios-de-organização). Na edição impressa, p. 34.

- [Eventos de saúde — seção “Do problema de saúde ao evento registrado”](eventos.html#do-problema-de-saúde-ao-evento-registrado). Na edição impressa, p. 52.
