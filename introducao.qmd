...
- [Breve histórico da experiência brasileira — seção “Sistemas nacionais e construção do SUS”](historico.html#sistemas-nacionais-e-construção-do-sus). Na edição impressa, p. 21.

- [Organização dos SIS — seção “Critérios de organização”](organizacao.html#critérios-de-organização). Na edição impressa, p. 29.

- [Eventos de saúde — seção “Do problema de saúde ao evento registrado”](eventos.html#do-problema-de-saúde-ao-evento-registrado). Na edição impressa, p. 45.
