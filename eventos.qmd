...
<audio class="podcast-audio" controls preload="metadata">
  <source src="https://sis-podcasts.nyc3.cdn.digitaloceanspaces.com/eventos_dialogo_eleven_v3.mp3" type="audio/mpeg">
...
%%| fig-alt: "Fluxograma de uma trajetória de dengue: sintomas levam a atendimento, notificação, investigação, internação, alta ou óbito; SIA, SINAN, SIH e SIM registram etapas diferentes."
flowchart LR
...
O óbito é um evento vital e epidemiológico central. Os óbitos são registrados no Sistema de Informações sobre Mortalidade (SIM) (@sec-sim), a partir da Declaração de Óbito. Esse sistema permite estudar mortalidade por idade, sexo, raça/cor, município de residência, município de ocorrência e causa de morte.
...
O nascimento de uma criança é um evento de saúde que envolve o recém-nascido, a pessoa gestante, a assistência ao pré-natal, o parto e as condições do nascimento. Os nascidos vivos são registrados no Sistema de Informações sobre Nascidos Vivos (SINASC) (@sec-sinasc), a partir da Declaração de Nascido Vivo.
...
- [Organização dos SIS — seção “Como escolher o sistema”](organizacao.html#como-escolher-o-sistema). Na edição impressa, p. 48.

- [SIM — Sistema de Informações sobre Mortalidade — seção “Causa básica do óbito”](sim.html#causa-básica-do-óbito). Na edição impressa, p. 77.

- [SINAN — Sistema de Informações de Agravos de Notificação — seção “Definições de caso”](sinan.html#definições-de-caso). Na edição impressa, p. 167.

- [SISCAN — Sistema de Informação do Câncer — seção “Quando usar o SISCAN”](siscan.html#quando-usar-o-siscan). Na edição impressa, p. 218.

- [Inquéritos e pesquisas de saúde — seção “Inquéritos e sistemas de informação”](inqueritos.html#inquéritos-e-sistemas-de-informação). Na edição impressa, p. 408.
