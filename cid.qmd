...
::: {#qua-cid-caracteristicas-gerais-da-cid}
...
Use a CID quando a pergunta envolve causas, diagnósticos, agravos, causas externas ou agrupamentos clínico-epidemiológicos. O mesmo código pode aparecer em sistemas diferentes, mas o campo em que ele aparece muda a interpretação (ver @qua-cid-usos-frequentes-da-cid-nos-sis).

::: {#qua-cid-usos-frequentes-da-cid-nos-sis}
...
A CID-10 é organizada de forma hierárquica. Em análises de SIS, é comum alternar entre níveis amplos, como capítulos, e níveis detalhados, como subcategorias de quatro caracteres (ver @qua-cid-niveis-hierarquicos-comuns-da-cid-10).

::: {#qua-cid-niveis-hierarquicos-comuns-da-cid-10}
...
Você pode acessar e explorar o catálogo da CID-10 no quadro abaixo:
...
Nos endereços a seguir, você pode consultar a hierarquia da CID-10 e da CID-11:
...
A CID-11 foi adotada pela 72ª Assembleia Mundial da Saúde em maio de 2019 e entrou em vigor internacionalmente em 1º de janeiro de 2022 [@whoICDPage2026]. Ela foi desenhada para uso digital, com ferramentas *on-line*, API, tradução controlada e maior flexibilidade de codificação [@whoICD11FactSheet2022].
...
::: {#qua-cid-cuidados-frequentes-ao-usar-codigos-cid}
...
Os cuidados reunidos no @qua-cid-cuidados-frequentes-ao-usar-codigos-cid reforçam que a CID é uma infraestrutura de comparabilidade. Seu valor analítico depende menos do código isolado e mais da combinação entre revisão, campo, sistema de origem, regra de codificação e nível de agregação.
...
- [SIM — Sistema de Informações sobre Mortalidade — seção “Codificação pela CID”](sim.html#codificação-pela-cid). Na edição impressa, p. 79.

- [SIH — Sistema de Informações Hospitalares do SUS — seção “Diagnóstico, procedimento e valores”](sih.html#diagnóstico-procedimento-e-valores). Na edição impressa, p. 121.
