...
O @qua-cid-cuidados-frequentes-ao-usar-codigos-cid sintetiza os elementos discutidos. Em síntese, a CID é uma infraestrutura de comparabilidade. Seu valor analítico depende menos do código isolado e mais da combinação entre revisão, campo, sistema de origem, regra de codificação e nível de agregação.
...
- [SIH — Sistema de Informações Hospitalares do SUS — seção “Diagnóstico, procedimento e valores”](sih.html#diagnóstico-procedimento-e-valores). Na edição impressa, p. 106.
